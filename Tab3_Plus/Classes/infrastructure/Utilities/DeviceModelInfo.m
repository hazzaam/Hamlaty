...
+ (NSNumber *)iPhone5Family {
    NSString* device = [self deviceModel];
    if ([device isEqualToString:@"iPhone5,1"] || [device isEqualToString:@"iPhone5,2"] || [device isEqualToString:@"iPhone5,3"] || [device isEqualToString:@"iPhone5,4"] || [device isEqualToString:@"iPhone6,1"] || [device isEqualToString:@"iPhone6,2"] || [device isEqualToString:@"iPhone8,4"]) {
        return @YES;
    }
...
+ (NSNumber *)iPhone6Plus {
    NSString* device = [self deviceModel];
    if ([device isEqualToString:@"iPhone7,1"] || [device isEqualToString:@"iPhone8,2"]) {
        return @YES;
    }
